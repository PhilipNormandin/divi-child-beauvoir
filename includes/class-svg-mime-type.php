...
if ( ! class_exists( 'Divi_Svg_Mime_Type' ) ) {
	...
	class Divi_Svg_Mime_Type {
		...
		public function __construct() {
			add_filter('upload_mimes', array( $this, 'beauvoir_svg_mime_support') );
			add_action('admin_enqueue_scripts', array( $this, 'beauvoir_fix_svg_thumb_display') );
		}

		public function beauvoir_svg_mime_support( $file_types ) {
		...
		function beauvoir_fix_svg_thumb_display() { ?>
			<style type="text/css">
