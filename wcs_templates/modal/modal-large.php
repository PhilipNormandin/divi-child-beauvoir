	...
	<div class="wcs-modal" :class="modal_classes" v-on:click="closeModal">
		<div class="wcs-modal__box">
			<div class="wcs-modal__inner">
				...
				<div class="wcs-modal__side" :style="data.image ? 'background-image: url(' + {{ data.image }}.substring(0, {{ data.image }}.lastIndexOf(".")) + "-600x400" + {{ data.image }}.substring({{ data.image }}.lastIndexOf(".")); + ')' : ''">
