	...
	<div class="wcs-class__content">
		...
		<div class="wcs-class__time-location">
			<span class="wcs-class__time">
                ...
                <template v-if="isMultiDay(single)"> <?php echo __( 'test', 'divi-child-beauvoir' ) ?> {{ single.end | moment( options.label_dateformat ? options.label_dateformat : 'dddd, MMMM D' ) }} {{ data.end | moment('YYYY') }}</template>
            </span>
